    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <span className="bg-purple-600 text-white px-4 py-2 rounded-full text-sm font-semibold">
                Bridal Makeup Artist in Pala • 6+ Years Experience
              </span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 text-center">
              Bridal Makeup <span className="text-purple-600">Pala</span> | Wedding Makeup Services
            </h1>
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-12">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 text-center">
                <div className="text-3xl mb-2">📍</div>
                <div className="text-2xl font-bold text-purple-600">Pala</div>
            ...
            <div className="text-center mb-8">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 inline-block mb-6">
                <p className="text-blue-800">Weekend dates fill up quickly - contact early to check availability</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link 
                  href="/contact"
                  className="bg-purple-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-purple-700 transition"
                >
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12">Wedding Makeup Services in Pala</h2>
            
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border border-purple-200">
                <div className="text-3xl mb-4">🎨</div>
                <h3 className="text-2xl font-bold mb-4 text-purple-800">HD Bridal Makeup</h3>
                ...
                <div className="text-2xl font-bold text-purple-600 mb-2">₹22,000 - ₹27,500</div>
                <Link 
                  href="/contact"
                  className="block w-full bg-purple-600 text-white px-4 py-3 rounded-lg font-semibold hover:bg-purple-700 transition text-center"
                >
                  Book HD Makeup
                </Link>
              </div>
              ...
              <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-8 border border-pink-200">
                <div className="text-3xl mb-4">💨</div>
                <h3 className="text-2xl font-bold mb-4 text-pink-800">Airbrush Bridal Makeup</h3>
                <p className="text-gray-700 mb-6">
                ...
                <div className="text-2xl font-bold text-pink-600 mb-2">₹25,000 - ₹32,000</div>
                <Link 
                  href="/contact"
                  className="block w-full bg-pink-600 text-white px-4 py-3 rounded-lg font-semibold hover:bg-pink-700 transition text-center"
                >
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border border-purple-200">
                <div className="text-3xl mb-4">👑</div>
                <h3 className="text-2xl font-bold mb-4 text-purple-800">Luxury Bridal Package</h3>
                <p className="text-gray-700 mb-6">
                ...
                <div className="text-2xl font-bold text-purple-600 mb-2">₹35,000 - ₹45,000</div>
                <Link 
                  href="/contact"
                  className="block w-full bg-purple-600 text-white px-4 py-3 rounded-lg font-semibold hover:bg-purple-700 transition text-center"
                >
            ...
            <div className="bg-purple-50 rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-6 text-center">What's Included in Every Package</h3>
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <h4 className="font-bold mb-3 text-purple-800">🎨 Pre-Wedding</h4>
                ...
                <div>
                  <h4 className="font-bold mb-3 text-purple-800">💍 Wedding Day</h4>
                  <ul className="space-y-2 text-sm text-gray-700">
                ...
                <div>
                  <h4 className="font-bold mb-3 text-purple-800">🎁 Post-Wedding</h4>
                  <ul className="space-y-2 text-sm text-gray-700">
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-12">
              <div>
                <h3 className="text-2xl font-bold mb-6 text-purple-600">🎯 Local Wedding Experience</h3>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-6 text-purple-600">💎 Quality Products</h3>
                <p className="text-gray-700 mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h3 className="text-2xl font-bold mb-6 text-purple-600">🏆 Consistent Results</h3>
                <p className="text-gray-700 mb-4">
                  Every bride gets the same careful process: skin analysis, product testing, and practice sessions 
                  until we achieve the exact look you want. This step-by-step approach ensures reliable results 
                  regardless of venue or weather conditions.
                </p>
                <div className="space-y-3">
                  <div className="flex items-start">
                    <span className="text-purple-600 mr-3">•</span>
                    <span>Systematic approach for every bride</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-purple-600 mr-3">•</span>
                    <span>120+ 5-star Google reviews</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-purple-600 mr-3">•</span>
                    <span>Documented portfolio of real work</span>
                  </div>
                </div>
              </div>
              
              <div>
                <h3 className="text-2xl font-bold mb-6 text-purple-600">🤝 Personal Process</h3>
                <p className="text-gray-700 mb-4">
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-purple-600 to-pink-600">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-8 text-purple-800">
